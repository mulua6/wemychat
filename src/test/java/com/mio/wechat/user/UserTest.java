...
public class UserTest {
	private com.mio.wechat.user.UserManager manager;
	@Before
	public void init(){
		manager = new com.mio.wechat.user.UserManager();
	}
	/**
	 * 获取所有的关注者列表
	 */
	...
	public void subscriberList(){
		com.mio.wechat.user.Follwers follwers = manager.subscriberList();
	...
	public void getUserInfo(){
		...
		com.mio.wechat.user.User user = manager.getUserInfo(openId);
		System.out.println(user.toString());
		user = manager.getUserInfo(openId, com.mio.wechat.user.LanguageType.en);
		System.out.println(user.toString());
	}
	/**
	 * 创建分组
	...
	public void getGroup(){
		List<com.mio.wechat.user.Group> groups = manager.getGroup();
		for (com.mio.wechat.user.Group group : groups) {
