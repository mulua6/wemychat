...
public class CustomerServicesTest {
	private com.mio.wechat.csc.CustomerServicesManager manager;
	@Before
	public void init(){
		manager = new com.mio.wechat.csc.CustomerServicesManager();
	}
	/**
	 * 创建会话
	 */
	...
	public void getSession(){
		...
		com.mio.wechat.csc.CustomerServicesSession customerServicesSession = manager.getSession(openId);
	...
	public void getSessionList(){
		...
		List<com.mio.wechat.csc.CustomerServicesSession> customerServicesSessions = manager.getSessionList(kfAccount);
		for (com.mio.wechat.csc.CustomerServicesSession customerServicesSession : customerServicesSessions) {
	...
	public void getWaitCaseList(){
		List<com.mio.wechat.csc.CustomerServicesSession> customerServicesSessions = manager.getWaitCaseList();
	...
	public void getKfList(){
		List<com.mio.wechat.csc.CustomerServices> customerServices = manager.getKfList();
		System.out.println("获取所有客服");
		for (com.mio.wechat.csc.CustomerServices cs : customerServices) {
	...
	public void getOnlieKfList(){
		List<com.mio.wechat.csc.CustomerServices> customerServices = manager.getOnlieKfList();
	...
	public void getRecord(){
		...
		int pageindex=1;
		int pagesize=50;
		List<com.mio.wechat.csc.Record> records = manager.getRecord(starttime, endtime, pageindex, pagesize);
		for (com.mio.wechat.csc.Record record : records) {
			System.out.println("用户的标识:"+record.getOpenid());
			System.out.println("操作ID:"+record.getOpercode());
			System.out.println("会话状态:"+ com.mio.wechat.csc.RecordOperCode.getSessionState(record.getOpercode()));
